$(document).ready(function(){
    ...
    $(document).on('click', '#generate-code-button', function(){
        ...
        <td style="height: 220px; vertical-align: top; font-size: 15px;">
